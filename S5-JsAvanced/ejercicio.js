...
$labelhoras.textContent = 'Cantidad de Horas Trabajadas:';
...
$labelcategoria.textContent = 'Elija su categoria:'
...
$labelanios.textContent = 'Elija sus tus años de servicio:';
...
$btnsubmit.classList.add('btn', 'btn-info', 'w-100', 'my-2')
...
$btnsubmit.addEventListener('click', (e) => {
    ...
    div.classList.add('my-4','bg-secondary', 'text-light', 'rounded')

    alert('Gracias por su atención, que tenga buen día!!!')
